...
install-env:
	@printf "${INFO}vue init webpack-simple .${NL}"
	@vue init webpack-simple .
	@printf "${INFO}yarn add vue-router vuex vuex-map-fields babel-plugin-transform-builtin-extend babel-preset-es2015 babel-preset-stage-2 lodash${NL}"
...
doc:
	@printf "${INFO}nohup xdg-open https://api-platform.com/docs/client-generator/vuejs >/dev/null 2>&1${NL}"
...
generate:
	@printf "${INFO}npx @api-platform/client-generator http://symfony.localhost/api src/ --generator vue --resource tag${NL}"
